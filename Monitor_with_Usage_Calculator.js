...
class Event {
    ...
    vmType: String denoting the type of VM when the event was called (not after). Options are "Basic" | "Large" | "Ultra-Large"
    ccID: String denoting the ID of the customer
}
*/
...
// let cycle = {
//     duration: how long was this cycle
//     vmType: during this cycle, which type of vm was used 
//     charge: how much money was charged for this cycle 
// }
        ...
        listOfVms.forEach(vm => {
            ...
            for (i = 0; i < usageEvents.length; i++){
                ...
                if (usageEvents[i].eventType == "Start"){
                    ...
                    let cycle = {
                        duration: usageEvents[i].eventTime - previousEvent.eventTime,
                        vmType: usageEvents[i].vmType,
                        charge: (usageEvents[i].eventTime - previousEvent.eventTime)*rate
                    }
